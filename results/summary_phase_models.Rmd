...
ggplot(comb.long, aes(x = Posterior, y = area,fill=area)) + 
	geom_density_ridges()+
	scale_fill_manual(values=main.col) +
	scale_x_reverse(breaks=BCADtoBP(c(-2000,-1800,-1600,-1400,-1200,-1000,-800,-600,-400,-200,1,200)),labels=c('2000BC','1800BC','1600BC','1400BC','1200BC','1000BC','800BC','600BC','400BC','200BC','1AD','200AD'),limits=c(4000,1700)) +
	theme(legend.position = "none")
```
