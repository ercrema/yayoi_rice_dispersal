...
#Run MCMC
mcmc.samples1<- nimbleMCMC(code = model1,constants = constants1,data = d1,niter = 100000, nchains = 3, thin=1, nburnin = 50000,monitors=c('a','b','theta'), inits=inits1, samplesAsCodaMCMC=TRUE)
...
#Run MCMC
mcmc.samples2<- nimbleMCMC(code = model2,constants = constants2,data = d2,niter = 100000, nchains = 3, thin=1, nburnin = 50000,monitors=c('a','b','theta','gamma1','gamma2'), inits=inits2, samplesAsCodaMCMC=TRUE)
